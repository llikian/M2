/***************************************************************************************************
 * @file  MeshRC.cpp
 * @brief Implementation of the MeshRC class
 **************************************************************************************************/
...
std::ostream& operator<<(std::ostream& stream, const MeshRC::Triangle& tri) {
    stream << "verts: (" << tri.a << ", " << tri.b << ", " << tri.c << ") ; ";
    stream << "faces: (" << tri.face_a << ", " << tri.face_b << ", " << tri.face_c << ")\n";
    return stream;
}

MeshRC::Vertex::Vertex(float x, float y, float z, unsigned int face) : Point(x, y, z), face(face) {}

MeshRC::Triangle::Triangle(unsigned int a,
                           unsigned int b,
                           unsigned int c,
                           unsigned int face_a,
                           unsigned int face_b,
...
void MeshRC::make_tetrahedron(Point top, Point A, Point B, Point C) {
...
void MeshRC::make_square_pyramid(Point top, Point A, Point B, Point C, Point D) {
...
void MeshRC::make_bounding_box_2D(float min_x, float min_y, float max_x, float max_y) {
...
void MeshRC::save_to_off(const std::filesystem::path& path) {
...
void MeshRC::load_from_off(const std::filesystem::path& path) {
